"""
A Python library for accessing the TVMaze API.
...
TVMaze.com is properly credited as the source. You can do this by linking
...
and the project team is not affiliated in any way with TVMaze.com. Any
